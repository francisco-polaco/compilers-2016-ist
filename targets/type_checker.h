// $Id: type_checker.h,v 1.28 2016/05/18 21:26:16 ist179719 Exp $ -*- c++ -*-
...
namespace zu {
  ...
  protected:
    ...
    void processBinaryExpressionIntDoublePointer(cdk::binary_expression_node * const node, int lvl);
