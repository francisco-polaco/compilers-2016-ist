// $Id: basic_ast_visitor.h,v 1.27 2016/04/14 19:19:19 ist179719 Exp $ -*- c++ -*-
...
public:
  virtual void do_function_invocation_node(zu::function_invocation_node * const node, int lvl) = 0;
...
public:
  ...
  virtual void do_identifier_l_node(zu::identifier_l_node * const node, int lvl) = 0;
  ...
  virtual void do_mem_index_node(zu::mem_index_node * const node, int lvl) = 0;
  virtual void do_mem_position_node(zu::mem_position_node * const node, int lvl) = 0;
  virtual void do_var_initialization_node(zu::var_initialization_node * const node, int lvl) = 0;
  virtual void do_var_declaration_node(zu::var_declaration_node * const node, int lvl) = 0;
